...
CharCode charCodes[256] = {
  ...
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER,
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LBRACKET, CHAR_UNKNOWN, CHAR_RBRACKET, CHAR_UNKNOWN, CHAR_UNDERSCORE, // EDITED HERE from CHAR_UNKNOWN to CHAR_UNDERSCORE, CHAR_LBRACKET, CHAR_RBRACKET
